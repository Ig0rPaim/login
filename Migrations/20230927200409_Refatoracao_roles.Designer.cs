...
namespace LoginAPI.Migrations
{
    ...
    [Migration("20230927200409_Refatoracao_roles")]
    partial class Refatoracao_roles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LoginAPI.Models.UserModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataCadastro = new DateTime(2023, 9, 27, 17, 4, 9, 696, DateTimeKind.Local).AddTicks(1199),
                        ...
                        new
                        {
                            Id = 2,
                            BytePassword = new byte[] { 91, 170, 97, 228, 201, 185, 63, 63, 6, 130, 37, 11, 108, 248, 51, 27, 126, 230, 143, 216 },
                            DataCadastro = new DateTime(2023, 9, 27, 17, 4, 9, 696, DateTimeKind.Local).AddTicks(1288),
                        ...
                        new
                        {
                            Id = 3,
                            BytePassword = new byte[] { 91, 170, 97, 228, 201, 185, 63, 63, 6, 130, 37, 11, 108, 248, 51, 27, 126, 230, 143, 216 },
                            DataCadastro = new DateTime(2023, 9, 27, 17, 4, 9, 696, DateTimeKind.Local).AddTicks(1404),
