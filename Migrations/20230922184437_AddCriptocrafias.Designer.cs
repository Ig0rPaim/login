...
namespace LoginAPI.Migrations
{
    ...
    [Migration("20230922184437_AddCriptocrafias")]
    partial class AddCriptocrafias
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LoginAPI.Models.UserModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataCadastro = new DateTime(2023, 9, 22, 15, 44, 37, 697, DateTimeKind.Local).AddTicks(6824),
                        ...
                        new
                        {
                            Id = 2,
                            BytePassword = new byte[] { 91, 170, 97, 228, 201, 185, 63, 63, 6, 130, 37, 11, 108, 248, 51, 27, 126, 230, 143, 216 },
                            DataCadastro = new DateTime(2023, 9, 22, 15, 44, 37, 697, DateTimeKind.Local).AddTicks(6864),
                        ...
                        new
                        {
                            Id = 3,
                            BytePassword = new byte[] { 91, 170, 97, 228, 201, 185, 63, 63, 6, 130, 37, 11, 108, 248, 51, 27, 126, 230, 143, 216 },
                            DataCadastro = new DateTime(2023, 9, 22, 15, 44, 37, 697, DateTimeKind.Local).AddTicks(6910),
