...
namespace LoginAPI.Migrations
{
    ...
    [Migration("20230922185509_AddCriptocrafias_Email")]
    partial class AddCriptocrafias_Email
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LoginAPI.Models.UserModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataCadastro = new DateTime(2023, 9, 22, 15, 55, 9, 282, DateTimeKind.Local).AddTicks(1119),
                        ...
                        new
                        {
                            Id = 2,
                            BytePassword = new byte[] { 91, 170, 97, 228, 201, 185, 63, 63, 6, 130, 37, 11, 108, 248, 51, 27, 126, 230, 143, 216 },
                            DataCadastro = new DateTime(2023, 9, 22, 15, 55, 9, 282, DateTimeKind.Local).AddTicks(1227),
                        ...
                        new
                        {
                            Id = 3,
                            BytePassword = new byte[] { 91, 170, 97, 228, 201, 185, 63, 63, 6, 130, 37, 11, 108, 248, 51, 27, 126, 230, 143, 216 },
                            DataCadastro = new DateTime(2023, 9, 22, 15, 55, 9, 282, DateTimeKind.Local).AddTicks(1292),
